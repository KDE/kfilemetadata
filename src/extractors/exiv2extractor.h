...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.kde.kf5.kfilemetadata.ExtractorPlugin" FILE "exiv2extractor.json")
...
private:
    void add(ExtractionResult *result, const Exiv2::ExifData &data, Property::Property prop, const char *name, QVariant::Type type);
