    ...
    : d(new Private)
{
    ...
    case Property::TranslationUnitsTotal:
        ...
        d->displayName = i18nc("@label number of translatable strings", "Translatable Units");
        d->valueType = QVariant::Int;
        d->shouldBeIndexed = false;
        break;
    ...
    case Property::TranslationUnitsWithDraftTranslation:
        ...
        d->displayName = i18nc("@label number of fuzzy translated strings", "Draft Translations");
        d->valueType = QVariant::Int;
        d->shouldBeIndexed = false;
        break;
    ...
    if (d->valueType == QVariant::Int || d->valueType == QVariant::DateTime || d->valueType == QVariant::Double) {
        d->shouldBeIndexed = false;
    }
}
...
{
    return d->name == rhs.d->name && d->displayName == rhs.d->displayName && d->prop == rhs.d->prop && d->shouldBeIndexed == rhs.d->shouldBeIndexed;
}
