...
{
    PropertyInfoData{ Property::AccessibleAltText,          true,  QStringLiteral("accessibleAltText"),          kli18nc("@label accessible alt text", "Accessible Description"), QMetaType::QString },
