...
void Exiv2ExtractorTest::test()
{
    ...
    QCOMPARE(result.properties().value(AccessibleAltText).toString(),
...
void Exiv2ExtractorTest::testJpegJxlProperties()
{
    ...
    verifyProperty(Property::AccessibleAltText, QStringLiteral("A blurry mess with a black-gray-blue area at the top and beige at the bottom"));
}
